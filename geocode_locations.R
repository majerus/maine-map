...
# sheet is not private so no need to authenticate
gs4_deauth()

# read maine place data into a dataframe 
maine <- read_sheet(ss = "https://docs.google.com/spreadsheets/d/1E9ARIwEj76Atp_kbYziGAWNAyLK82tO_Ad5IdRMjpWE/edit#gid=0", 
